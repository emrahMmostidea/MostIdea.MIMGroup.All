...
using MostIdea.MIMGroup.Web.Public.Startup;
using MostIdea.MIMGroup.Web.Session;

namespace MostIdea.MIMGroup.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : MIMGroupViewComponent
    {
