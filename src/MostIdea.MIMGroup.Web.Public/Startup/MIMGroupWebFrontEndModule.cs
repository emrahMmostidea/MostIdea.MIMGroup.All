...
namespace MostIdea.MIMGroup.Web.Public.Startup
{
    [DependsOn(
        typeof(MIMGroupWebCoreModule)
    )]
    public class MIMGroupWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public MIMGroupWebFrontEndModule(IWebHostEnvironment env, MIMGroupEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MIMGroupWebFrontEndModule).GetAssembly());
        }
    }
}
