...
using MostIdea.MIMGroup.Services.Navigation;
...
using MostIdea.MIMGroup.Controls;
using MostIdea.MIMGroup.Dto;
using MostIdea.MIMGroup.Extensions;
using MostIdea.MIMGroup.Localization;
using MostIdea.MIMGroup.UI;
using MostIdea.MIMGroup.UI.Assets;
using MostIdea.MIMGroup.Views;
using DependencyResolver = MostIdea.MIMGroup.Core.Dependency.DependencyResolver;
...
namespace MostIdea.MIMGroup.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "MIMGroup";
