...
using MostIdea.MIMGroup.Auditing.Exporting;
...
using EntityHistoryHelper = MostIdea.MIMGroup.EntityHistory.EntityHistoryHelper;

namespace MostIdea.MIMGroup.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : MIMGroupAppServiceBase, IAuditLogAppService
    {
