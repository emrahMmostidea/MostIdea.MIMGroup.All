...
namespace MostIdea.MIMGroup.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : MIMGroupAppServiceBase, IDashboardCustomizationAppService
    {
