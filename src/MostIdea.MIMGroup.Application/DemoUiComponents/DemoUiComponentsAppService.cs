...
using MostIdea.MIMGroup.DemoUiComponents.Dto;

namespace MostIdea.MIMGroup.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : MIMGroupAppServiceBase, IDemoUiComponentsAppService
    {
