...
using MostIdea.MIMGroup.DynamicEntityPropertyValues.Dto;
...
namespace MostIdea.MIMGroup.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : MIMGroupAppServiceBase, IDynamicEntityPropertyValueAppService
    {
