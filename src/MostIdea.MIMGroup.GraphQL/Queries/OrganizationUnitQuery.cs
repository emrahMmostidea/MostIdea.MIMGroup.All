...
using MostIdea.MIMGroup.Core.Base;
using MostIdea.MIMGroup.Core.Extensions;
using MostIdea.MIMGroup.Dto;
using MostIdea.MIMGroup.Types;

namespace MostIdea.MIMGroup.Queries
{
    public class OrganizationUnitQuery : MIMGroupQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
