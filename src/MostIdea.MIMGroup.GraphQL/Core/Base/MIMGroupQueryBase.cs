...
namespace MostIdea.MIMGroup.Core.Base
{
    public abstract class MIMGroupQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected MIMGroupQueryBase(string fieldName,
