    ...
    public partial class Hospital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HospitalVsUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HospitalVsUsers_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HospitalVsUsers_Hospitals_HospitalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HospitalVsUsers_HospitalId",
                table: "HospitalVsUsers",
                column: "HospitalId");

            migrationBuilder.CreateIndex(
                name: "IX_HospitalVsUsers_UserId",
                table: "HospitalVsUsers",
                column: "UserId");
        }
