        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AbpUsers_CourierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehouseVsCouriers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WarehouseVsCouriers_AbpUsers_CourierId",
                        column: x => x.CourierId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WarehouseVsCouriers_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ProductPricesForHospitals",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPricesForHospitals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductPricesForHospitals_ProductCategories_ProductCategoryId",
                        column: x => x.ProductCategoryId,
                        principalTable: "ProductCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductPricesForHospitals_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPricesForHospitals_ProductCategoryId",
                table: "ProductPricesForHospitals",
                column: "ProductCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductPricesForHospitals_ProductId",
                table: "ProductPricesForHospitals",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseVsCouriers_CourierId",
                table: "WarehouseVsCouriers",
                column: "CourierId");

            migrationBuilder.CreateIndex(
                name: "IX_WarehouseVsCouriers_WarehouseId",
                table: "WarehouseVsCouriers",
                column: "WarehouseId");
        }
