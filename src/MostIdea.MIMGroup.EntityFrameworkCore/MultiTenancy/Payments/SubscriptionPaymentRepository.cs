...
{
    public class SubscriptionPaymentRepository : MIMGroupRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<MIMGroupDbContext> dbContextProvider)
