...
using MostIdea.MIMGroup.EntityFrameworkCore.Repositories;

namespace MostIdea.MIMGroup.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : MIMGroupRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<MIMGroupDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
