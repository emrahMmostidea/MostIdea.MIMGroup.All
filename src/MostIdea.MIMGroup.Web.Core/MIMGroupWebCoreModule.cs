...
using MostIdea.MIMGroup.Web.Authentication.JwtBearer;
using MostIdea.MIMGroup.Web.Authentication.TwoFactor;
using MostIdea.MIMGroup.Web.Chat.SignalR;
using MostIdea.MIMGroup.Web.Common;
using MostIdea.MIMGroup.Web.Configuration;
using MostIdea.MIMGroup.Web.DashboardCustomization;

namespace MostIdea.MIMGroup.Web
{
    [DependsOn(
        typeof(MIMGroupApplicationModule),
        typeof(MIMGroupEntityFrameworkCoreModule),
    ...
    public class MIMGroupWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MIMGroupWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(MIMGroupApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MIMGroupWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(MIMGroupWebCoreModule).Assembly);
        }
