...
using MostIdea.MIMGroup.Web.Startup.ExternalLoginInfoProviders;
...
namespace MostIdea.MIMGroup.Web.Startup
{
    ...
    public class MIMGroupWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MIMGroupWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MIMGroupWebHostModule).GetAssembly());
        }
