...
using MostIdea.MIMGroup.MultiTenancy.Demo;
...
namespace MostIdea.MIMGroup.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(MIMGroupConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(MIMGroupConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
