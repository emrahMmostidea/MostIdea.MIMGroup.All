...
{
    public class StripeGatewayManager : MIMGroupServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "MIMGroup";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + MIMGroupConsts.Currency;
        }
