...
using MostIdea.MIMGroup.Authorization.Permissions;
...
using MostIdea.MIMGroup.Web.Areas.App.Models.Roles;
...
namespace MostIdea.MIMGroup.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class UsersController : MIMGroupControllerBase
    {
        ...
        [AbpMvcAuthorize(AppPermissions.Pages_Administration_Users)]
        [Route("App/GetUsersForType/{type}")]
        [HttpGet]
        public async Task<ActionResult> GetUsersForType(string type)
        {
            //TODO : UserTypeEnum 'a göre düzenlenecek
            string role = "";
            if (type == "Doctors")
            {
                role = "6";
