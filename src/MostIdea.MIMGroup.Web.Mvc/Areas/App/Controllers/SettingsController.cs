...
using MostIdea.MIMGroup.Configuration.Tenants;
using MostIdea.MIMGroup.MultiTenancy;
using MostIdea.MIMGroup.Timing;
using MostIdea.MIMGroup.Timing.Dto;
using MostIdea.MIMGroup.Web.Areas.App.Models.Settings;
...
namespace MostIdea.MIMGroup.Web.Areas.App.Controllers
{
    ...
    public class SettingsController : MIMGroupControllerBase
    {
