...
namespace MostIdea.MIMGroup.Web.Areas.App.Views.Shared.Themes.Theme5.Components.AppTheme5Footer
{
    public class AppTheme5FooterViewComponent : MIMGroupViewComponent
    {
