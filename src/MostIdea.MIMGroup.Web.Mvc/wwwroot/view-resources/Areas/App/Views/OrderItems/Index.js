            ...
            listAction: {
                ...
                inputFilter: function() {
                    return {
                        ...
                        orderOrderNoFilter: $('#OrderOrderNoFilterId').val()
                    };
                }
            },
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(status) {
                        return app.localize('Enum_OrderItemStatusEnum_' + status);
                    }
                },
                {
                    targets: 5,
