...
using MostIdea.MIMGroup.MultiTenancy.HostDashboard;
...
namespace MostIdea.MIMGroup.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(MIMGroupDbContext context, SubscriptionPayment subscriptionPayment)
        {
