...
$webMvcFolder = Join-Path $slnFolder "src/MostIdea.MIMGroup.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/MostIdea.MIMGroup.Web.Public"
...
dotnet restore MostIdea.MIMGroup.Web.sln
